...
public class GameActivity3 extends AppCompatActivity {
    ...
    String[] wordList =
            {
                "JINGLE", "FROZEN", "JUDGES", "ABSURD", "AMBUSH", "ANCHOR", "ATOMIC", "BACKUP", "BAKERY", "BANISH",
                "BECKON", "BEAUTY", "BOUGHT", "BRANCH", "BREAST", "BUTLER" ,"CAUGHT", "CENSOR", "CHAPEL", "CLOSED",
                "DETAIL", "COURSE", "CREDIT" ,"ENLIST", "ENTRAP", "FACTOR", "FABRIC", "FALCON", "FATHER", "FRIEND" ,
                "GLIDER", "GLITCH", "HEIGHT" ,"FAMILY", "INJURY", "INJURE", "ISLAND", "KIDNAP", "LAYOUT", "LEGACY" ,
                "LEGION", "MAGNET", "MANTEL" ,"MARBLE", "MARVEL", "MODULE", "NAPKIN", "NATIVE", "NATURE", "PARENT" ,
                "PARODY", "PAROLE", "PATROL" ,"PREACH", "RATION", "RESCUE", "SCREAM", "SHRIMP", "SHIELD", "VOYAGE"
            };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        letter6.setText("" + firstWord.charAt(5));
        ...
        button6letter = letter6.getText().toString();
        ...
        letter6.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                letter6.setTextColor(gray);
                display.setText(display.getText() + letter6.getText().toString());
        ...
        backspace.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                char sixthLetter = letter6.getText().toString().charAt(0);
                String stringSixthLetter = Character.toString(sixthLetter);
                ...
                if (text.length() > 0) {
                    ...
                    if (display.getText().toString().endsWith(stringSixthLetter)) {
                        letter6.setTextColor(white);
                        letter6.setEnabled(true);
                        display.setText
                                (display.getText().toString().substring(
        ...
        submit.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(display.getText().toString().length() == 6)
                {
                    ...
                    if (count == -1) {
                        timer.cancel();
                        Intent fp = new Intent(getApplicationContext(), ResultsActivity3.class);
                        startActivity(fp);
                        PopupActivity.hard = false;
                        return;
                    }
                }
            }
        ...
        skip.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                count--;
                answers[answerCounter] = "_ _ _ _ _ _ _";
                answerCounter++;
    ...
    public void startTimer()
    {
        timer = new CountDownTimer( timeLeftMilliseconds, 1000 )
        {
            ...
            {
                timer.cancel();
                Intent activateResult = new Intent(getApplicationContext(), ResultsActivity3.class);
